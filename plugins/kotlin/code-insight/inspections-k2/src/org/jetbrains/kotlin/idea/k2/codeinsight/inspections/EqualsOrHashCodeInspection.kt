...
import org.jetbrains.kotlin.idea.codeinsight.utils.GenerateFunctionFix
import org.jetbrains.kotlin.idea.codeinsight.utils.matchesEqualsMethodSignature
import org.jetbrains.kotlin.idea.codeinsight.utils.matchesHashCodeMethodSignature
...
class EqualsOrHashCodeInspection : AbstractKotlinInspection() {
     ...
     *
     * TODO: Handle JS case. Since using `isJs` function of [org.jetbrains.kotlin.platform.TargetPlatform] reports the reference-not-found
     *  error, we need another way to handle it similar to
     *  `targetClass.platform.isJs() -> "other == null || this::class.js != $paramName::class.js"`. See the when entries.
     */
     ...
     * TODO: Handle JS case. Since using `isJs` function of [org.jetbrains.kotlin.platform.TargetPlatform] reports the reference-not-found
     *  error, we need another way to handle it similar to
     *  `targetClass.platform.isJs() -> "this::class.js"`. See the when entries.
     */
    ...
    private fun generateEqualsFunctionAndBodyTexts(targetClass: KtClass): Pair<String, String> {
        ...
        analyze(targetClass) {
             ...
             *  named "Any". We have to preserve the behavior here. We tried
             ...
             *  regardless of the user-defined "Any" class.
             *  Remove IGNORE_FIR directive from
             *  plugins/kotlin/idea/tests/testData/inspectionsLocal/equalsOrHashCode/inheritUserDefinedClassAny.kt after fixing
             *  this issue.
             */
            functionText = buildString {
                append("override fun equals(${parameterName}: Any?): Boolean")
                if (!hasExpectModifier) {
